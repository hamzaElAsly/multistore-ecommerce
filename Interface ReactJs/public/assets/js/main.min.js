...
$.extend($.easing, {
  ...
  (function (t) {
      ...
      (Wolmart.initScrollTopButton = function () {
        ...
        var i = function () {
          if (!e) return; // التحقق من أن e ليس null
          if (window.pageYOffset > 400) {
            e.classList.add("show");
            var docHeight = t(document).height(),
            winHeight = t(window).height(),
            scrollPos = (t(window).scrollTop() / (docHeight - winHeight)) * 214;
            if (t("#progress-indicator").length > 0) {
              t("#progress-indicator").css("stroke-dasharray", scrollPos + ", 400");
            }
          } else {
      ...
      (Wolmart.minipopupOption = {
        ...
        space: 20,
        template:
          '<div class="minipopup-box"><div class="product product-list-sm {{productClass}}"><figure class="product-media figure-img"><a href="{{imageLink}}"><img src="{{imageSrc}}" alt="Product" width="80" height="90" /></a></figure><div class="product-details"><h4 class="product-name"><a href="{{nameLink}}">{{name}}</a></h4>{{message}}</div></div><div class="product-action">{{actionTemplate}}</div></div>',
      }),
      (Wolmart.Minipopup =
        ((i = 0),
        (a = []),
        ...
        Wolmart.call(Wolmart.ratingTooltip, 500),
          ...
          Wolmart.$body.on(
            ...
            function (e) {
              ...
              i.hasClass("disabled")
                ? alert( "Veuillez sélectionner certaines options de produit avant d'ajouter ce produit à votre panier." )
                  ...
                  setTimeout(function () {
                    i.removeClass("load-more-overlay loading"),
                      Wolmart.Minipopup.open({
                        ...
                        message: "<p>A été ajouté au panier :</p>", //has been added to cart:
                        actionTemplate:
                          '<a href="/panier" class="btn btn-rounded btn-sm">Voir le panier</a><a href="/caisse" class="btn btn-dark btn-rounded btn-sm">La caisse </a>',
                      });
                  }, 500));
            }
          ),
